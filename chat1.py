...
st.markdown("---")
st.markdown("""
<div style="background-color: #481d00; text-align: center; font-size: 12px;">
    <p>Legal Disclaimer — The insights and visualisations generated by this tool are for informational purposes only and should not be considered financial, legal, or business advice.</p>
</div>
""", unsafe_allow_html=True)